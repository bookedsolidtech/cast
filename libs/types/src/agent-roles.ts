...
export const ROLE_CAPABILITIES: Record<AgentRole, RoleCapabilities> = {
	'product-manager': {
		...
		canCreatePRs: false,
		description:
			'Research codebase, engage with users, create SPARC PRDs, create Linear projects',
	},
	'engineering-manager': {
		...
		canCreatePRs: false,
		description:
			'Break down projects into features, assign to roles, manage PRs, trigger releases',
	},
	'frontend-engineer': {
	...
	'docs-engineer': {
		...
		canCreatePRs: true,
		description:
			'Update documentation, generate changelogs, maintain project docs',
	},
};
